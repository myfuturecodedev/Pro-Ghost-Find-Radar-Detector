...
/**
 * ─────────────────────────────────────────────────────────────────────────────
 * BaseDialog — Activity-context Dialog base ().
 *
 * Usage:
 *   val dialog = BaseDialog(requireActivity(), R.style.TransparentDialog)
 *   val binding = DialogApprovalBinding.inflate(LayoutInflater.from(requireContext()))
 *   dialog.bind(binding) {
 *       tvHead.text = "Hello"
 ...
 *
 *  OR subclass it:
 *   class ApprovalDialog(activity: Activity) : BaseDialog(activity) {
 *       override fun onCreate(...) {
 *           super.onCreate(...)
 *           val binding = DialogApprovalBinding.inflate(layoutInflater)
